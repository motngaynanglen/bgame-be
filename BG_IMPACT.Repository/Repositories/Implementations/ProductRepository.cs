...
namespace BG_IMPACT.Repositories.Implementations
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<(object? products, int totalCount)> spProductGetList(object param)
        {
            using var multi = await _connection.QueryMultipleAsync("spProductGetList", param, commandType: CommandType.StoredProcedure);
        ...
        public async Task<object?> spGetProductsByTemplateAndConditionPageData(object param)
        {
            object? result = await _connection.QueryFirstOrDefaultAsync("spGetProductsByTemplateAndConditionPageData", param, commandType: CommandType.StoredProcedure);
            return result;
        }
        ...
        public async Task<object?> spProductGetTemplateByAdmin(object param)
        {
