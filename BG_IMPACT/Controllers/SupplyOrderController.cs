...
namespace BG_IMPACT.Controllers
{
    ...
    public class SupplyOrderController : ControllerBase
    {
        ...
        [HttpPost("update-supply-order")]
        public async Task<IActionResult> UpdateSupplyOrder(UpdateSupplyOrderCommand command)
        {
            try
            {
                ResponseObject result = await _mediator.Send(command);
        ...
        [HttpPost("deactive-supply-order")]
        public async Task<IActionResult> DeactiveSupplyOrder(DeactiveSupplyOrderCommand command)
        {
            try
            {
                ResponseObject result = await _mediator.Send(command);
