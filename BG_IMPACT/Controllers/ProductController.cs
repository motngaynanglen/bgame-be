...
namespace BG_IMPACT.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByGroupRefId(GetProductListByGroupRefIdQuery command)
        {
            try
            {
                ResponseObject result = await _mediator.Send(command);
        ...
        [HttpPost("get-product-template-by-admin")]
        public async Task<IActionResult> GetProductTemplateByAdmin(GetProductTemplateByAdminQuery command)
        {
            try
            {
                ResponseObject result = await _mediator.Send(command);
