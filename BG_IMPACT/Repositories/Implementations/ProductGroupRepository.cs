...
namespace BG_IMPACT.Repositories.Implementations
{
    public class ProductGroupRepository : IProductGroupRepository
    {
        ...
        public async Task<object?> spProductGroupUpdate(object param)
        {
            object? result = await _connection.QueryFirstOrDefaultAsync("spProductGroupUpdate", param, commandType: CommandType.StoredProcedure);
            return result;
        }
