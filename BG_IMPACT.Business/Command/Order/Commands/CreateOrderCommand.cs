...
namespace BG_IMPACT.Business.Command.Order.Commands
{
    ...
    public class CreateOrderCommand : IRequest<ResponseObject>
    {
        ...
        public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand, ResponseObject>
        {
            ...
            public async Task<ResponseObject> Handle(CreateOrderCommand request, CancellationToken cancellationToken)
            {
                ...
                string ListProductTemplateIDs = string.Join(",", request.OrderItems
