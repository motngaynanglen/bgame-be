...
{
    public class DeactiveCategoryCommand : IRequest<ResponseObject>
    {
        [Required]
        ...
        public class DeactiveCategoryCommandCommandHandler : IRequestHandler<DeactiveCategoryCommand, ResponseObject>
        {
            ...
            public DeactiveCategoryCommandCommandHandler(ICategoryRepository categoryRepository, IHttpContextAccessor httpContextAccessor)
            {
                _categoryRepository = categoryRepository;
                _httpContextAccessor = httpContextAccessor;
            }

            public async Task<ResponseObject> Handle(DeactiveCategoryCommand request, CancellationToken cancellationToken)
            {
                ...
                if (context != null && context.GetRole() == "MANAGER" || context.GetRole() == "STAFF")
                {
                    ...
                    var result = await _categoryRepository.spCategoryDeactive(param);
